...
export default function LeaveReview() {
  ...
  if (!contract) return <div className="text-center text-neutral-400 mt-20">Contract not found.</div>;
  
  // Determine the state of reviews
    ...
    <div className="bg-neutral-950 min-h-screen text-white">
      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        ...
        <div className="space-y-6">
          {/* Show the review form if the user hasn't submitted one yet */}
          ...
          {/* Show the user's own submitted review */}
          {myReview && (
            <ReviewDisplayCard review={myReview} title="Your Submitted Review" />
          )}

          {/* Show the other party's review */}
          {otherPartyReview ? (
